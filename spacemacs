...
values."
  (setq-default
   ...
   '(
     ...
     version-control
     (wakatime :variables
      wakatime-api-key "8780df4b-58d2-4c4d-9982-9e1c42a34463"
...
`dotspacemacs/user-config'."
  ...
  ;; enable unicode character and ligatures support
  ...
  (setq wakatime-python-bin "/Users/rwa/.pyenv/versions/2.7.11/bin/python")
